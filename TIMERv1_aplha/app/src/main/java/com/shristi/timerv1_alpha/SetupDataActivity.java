...
public class SetupDataActivity extends AppCompatActivity implements SetupSlideDialogFragment.Communicator {
    ...
    private com.shristi.timerv1_alpha.Database db = new com.shristi.timerv1_alpha.Database(this);
        ...
        if (requestCode == ADD_DATA_REQUEST) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (enterNext) {
                    ...
                    Intent intent = new Intent(SetupDataActivity.this, com.shristi.timerv1_alpha.PreSlideSetup.class);
