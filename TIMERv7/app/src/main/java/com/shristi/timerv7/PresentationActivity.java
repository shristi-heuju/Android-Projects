...
public class PresentationActivity extends AppCompatActivity {
    ...
    public void setupTextSize() {
        DisplayMetrics metrics = Resources.getSystem().getDisplayMetrics();
        int heightPixels = metrics.heightPixels;
        int widthPixels = metrics.widthPixels;

        float scale = (float) (widthPixels) / 480;

        Log.e("Test", "" + scale + " : " + widthPixels + " : " + tvProgress.getTextSize() + " : " + tvProgress.getTextSize() * scale);

        tvSlideNameCaption.setTextSize(TypedValue.COMPLEX_UNIT_PX, tvSlideNameCaption.getTextSize() * scale);
        tvProgress.setTextSize(TypedValue.COMPLEX_UNIT_PX, tvProgress.getTextSize() * scale);
        tvSlideName.setTextSize(TypedValue.COMPLEX_UNIT_PX, tvSlideName.getTextSize() * scale);
        tvCurrentSlideCountDownCaption.setTextSize(TypedValue.COMPLEX_UNIT_PX, tvCurrentSlideCountDownCaption.getTextSize() * scale);
        tvCountDown.setTextSize(TypedValue.COMPLEX_UNIT_PX, tvCountDown.getTextSize() * scale);
        tvPresentationCountDownCaption.setTextSize(TypedValue.COMPLEX_UNIT_PX, tvPresentationCountDownCaption.getTextSize() * scale);
        tvTotalTime.setTextSize(TypedValue.COMPLEX_UNIT_PX, tvTotalTime.getTextSize() * scale);

        Log.e("Test", "" + scale + " : " + widthPixels + " : " + tvProgress.getTextSize() + " : " + tvProgress.getTextSize() * scale);

        tvCountDown.setTextSize(TypedValue.COMPLEX_UNIT_SP, textSizeBig * scale);
        //tvCountDown.setBackgroundColor(Color.BLACK);
        tvCountDown.setTextColor(Color.BLACK);
        //tvCountDown.setGravity(View.TEXT_ALIGNMENT_CENTER);
        //tvCountDown.setGravity(Gravity.CENTER_HORIZONTAL);
        ...
        tvTotalTime.setTextSize(TypedValue.COMPLEX_UNIT_SP, textSizeBig * scale);
        //tvTotalTime.setBackgroundColor(Color.BLACK);
        tvTotalTime.setTextColor(Color.BLACK);
        //tvTotalTime.setGravity(View.TEXT_ALIGNMENT_CENTER);
        //tvTotalTime.setGravity(Gravity.CENTER_HORIZONTAL);
        ...
        //btnNext.setTextSize(TypedValue.COMPLEX_UNIT_SP, btnNext.getTextSize() * scale);
        int size = (int) (60 * scale);
        btnNext.setHeight(size);
        btnNext.setWidth(size);

        //btnPause.setTextSize(TypedValue.COMPLEX_UNIT_SP, btnPause.getTextSize() * scale);
        btnPause.setHeight(size);
        btnPause.setWidth(size);

        //btnStop.setTextSize(TypedValue.COMPLEX_UNIT_SP, btnStop.getTextSize() * scale);
        btnStop.setHeight(size);
        btnStop.setWidth(size);
